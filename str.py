...
# 모델 파일 경로
model_face = core.read_model(model="D:/BrainAI/streamlit_project/models/face/face-detection-adas-0001.xml")
compiled_model_face = core.compile_model(model=model_face, device_name="CPU")
input_layer_face = compiled_model_face.input(0)
output_layer_face = compiled_model_face.output(0)

model_emo = core.read_model(model="D:/BrainAI/streamlit_project/models/emotion/emotions-recognition-retail-0003.xml")
compiled_model_emo = core.compile_model(model=model_emo, device_name="CPU")
input_layer_emo = compiled_model_emo.input(0)
output_layer_emo = compiled_model_emo.output(0)

model_ag = core.read_model(model="D:/BrainAI/streamlit_project/models/agegender/age-gender-recognition-retail-0013.xml")
...
# Streamlit 앱 시작
st.sidebar.title('메뉴')
option = st.sidebar.radio('메뉴 선택', ['Photo', 'Video', 'Webcam'])
